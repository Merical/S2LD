...
from datasets.megadepth import MegaDepthDataset, MegaDepthColorDataset
...
class MultiSceneDataModule(pl.LightningDataModule):
    ...
    def __init__(self, args, config):
        ...
        self.coarse_scale = 1 / config.S2LD.RESOLUTION[0]  
    ...
    def _build_concat_dataset(
        ...
        if str(data_source).lower() == 'megadepth' or 'metadepthcolor':
        ...
        for npz_name in tqdm(npz_names,
            ...
            elif data_source == 'MegaDepthColor':
                datasets.append(
                    MegaDepthColorDataset(data_root,
                                     npz_path,
                                     mode=mode,
                                     min_overlap_score=min_overlap_score,
                                     img_resize=self.mgdpt_img_resize,
